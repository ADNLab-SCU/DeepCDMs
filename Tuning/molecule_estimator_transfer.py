...
import molecule_predictors_transfer
...
flags.DEFINE_enum('model_type', 'mlp',
                  molecule_predictors_transfer.MODEL_REGISTRY.keys(),
...
def main(_):
  prediction_helper = molecule_predictors_transfer.get_prediction_helper(
      FLAGS.model_type)
