...
class MLPSpectraPrediction(MassSpectraPrediction):
  ...
  def _make_learned_features(self, feature_dict, hparams, mode):
    ...
    """
    The construct of the miltilayer model append if to judge whether the layer is the last layer.
    If the layer is not the last, frozen this layer. And the last layer should be trained. 
    """
    for _ in range(hparams.num_hidden_layers):
      if _ < hparams.num_hidden_layers - 1:
